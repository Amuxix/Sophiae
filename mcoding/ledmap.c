...
#define MAC_MODE_LED_ID 65
#define GUI_CTRL_SWAP_LED_ID 66
#define LAYER_LOCK_LED_ID 67
#define SPACE_SWAP_LED_ID 29
...
uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    [BASE] = LED_LAYOUT_moonlander(
      ...
      LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  XXXXXXXXXXXXX,                VITAMIN_C,     LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,
    ...
    [QWERTY_G] = LED_LAYOUT_moonlander(
      ...
      FOXY_FUCHSIA,  FOXY_FUCHSIA,  VITAMIN_C,     FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  XXXXXXXXXXXXX,                VITAMIN_C,     FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,
    ...
    [QWERTY_SG] = LED_LAYOUT_moonlander(
      ...
      BABY_MOUTH,    BABY_MOUTH,    BABY_MOUTH,    BABY_MOUTH,    BABY_MOUTH,    BABY_MOUTH,    BABY_MOUTH,                   VITAMIN_C,     BABY_MOUTH,    BABY_MOUTH,    BABY_MOUTH,    BABY_MOUTH,    BABY_MOUTH,    BABY_MOUTH,
    ...
    [KEYPAD_SYMB] = LED_LAYOUT_moonlander(
      ...
      XXXXXXXXXXXXX, BLINKING_TERM, BLINKING_TERM, BLINKING_TERM, BLINKING_TERM, BLINKING_TERM, XXXXXXXXXXXXX,                VITAMIN_C,     BLINKING_TERM, BLINKING_TERM, BLINKING_TERM, BLINKING_TERM, BLINKING_TERM, BLINKING_TERM,
    ...
    [EXTRA_SYMB] = LED_LAYOUT_moonlander(
      ...
      HOT_BUTTER,    LAVENDER_TEA,  HOT_BUTTER,    HOT_BUTTER,    HOT_BUTTER,    HOT_BUTTER,    XXXXXXXXXXXXX,                VITAMIN_C,     XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,
    ...
    [MOVEMENT] = LED_LAYOUT_moonlander(
      ...
      XXXXXXXXXXXXX, LAVENDER_TEA,  XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX,                VITAMIN_C,     SKY_BLUE,      SKY_BLUE,      SKY_BLUE,      SKY_BLUE,      LAVENDER_TEA,  LAVENDER_TEA,
