...
uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    [BASE] = LED_LAYOUT_moonlander(
      LAVENDER_TEA,  XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  VITAMIN_C,                    XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  XXXXXXXXXXXXX, LAVENDER_TEA,
    ...
    [CANARY_G] = LED_LAYOUT_moonlander(
      LAVENDER_TEA,  XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  VITAMIN_C,                    XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  XXXXXXXXXXXXX, XXXXXXXXXXXXX,
      LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  XXXXXXXXXXXXX,                XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  XXXXXXXXXXXXX,
    ...
    [QWERTY_G] = LED_LAYOUT_moonlander(
      FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  VITAMIN_C,                    XXXXXXXXXXXXX, FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  XXXXXXXXXXXXX, XXXXXXXXXXXXX,
      FOXY_FUCHSIA,  FOXY_FUCHSIA,  VITAMIN_C,     FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  XXXXXXXXXXXXX,                XXXXXXXXXXXXX, FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  FOXY_FUCHSIA,  XXXXXXXXXXXXX,
    ...
    [KEYPAD_SYMB] = LED_LAYOUT_moonlander(
      XXXXXXXXXXXXX, XXXXXXXXXXXXX, BLINKING_TERM, BLINKING_TERM, BLINKING_TERM, BLINKING_TERM, VITAMIN_C,                    XXXXXXXXXXXXX, BLINKING_TERM, BLINKING_TERM, BLINKING_TERM, BLINKING_TERM, XXXXXXXXXXXXX, BLINKING_TERM,
    ...
    [EXTRA_SYMB] = LED_LAYOUT_moonlander(
      XXXXXXXXXXXXX, XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  VITAMIN_C,                    XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  XXXXXXXXXXXXX, LAVENDER_TEA,
      XXXXXXXXXXXXX, LAVENDER_TEA,  HOT_BUTTER,    HOT_BUTTER,    HOT_BUTTER,    HOT_BUTTER,    XXXXXXXXXXXXX,                XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,
      HOT_BUTTER,    HOT_BUTTER,    SOIL_AVAGDDU,  SOIL_AVAGDDU,  SOIL_AVAGDDU,  HOT_BUTTER,    VITAMIN_C,                    LAVENDER_TEA,  XXXXXXXXXXXXX, SOIL_AVAGDDU,  SOIL_AVAGDDU,  SOIL_AVAGDDU,  XXXXXXXXXXXXX, XXXXXXXXXXXXX,
      HOT_BUTTER,    SOIL_AVAGDDU,  HOT_BUTTER,    HOT_BUTTER,    HOT_BUTTER,    HOT_BUTTER,                                                 XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX,
      HOT_BUTTER,    HOT_BUTTER,    XXXXXXXXXXXXX, XXXXXXXXXXXXX, VITAMIN_C,                    VITAMIN_C,                    VITAMIN_C,                    VITAMIN_C,     XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX,
                                                                  SOIL_AVAGDDU,  HOT_BUTTER,    HOT_BUTTER,                   HOT_BUTTER,    HOT_BUTTER,    SOIL_AVAGDDU
    ),
    [MOVEMENT] = LED_LAYOUT_moonlander(
      XXXXXXXXXXXXX, XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  VITAMIN_C,                    XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,
