...
uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [KEYPAD_SYMB] = LED_LAYOUT_moonlander(
      ...
      XXXXXXXXXXXXX, BLINKING_TERM, SERICOURT,     SERICOURT,     SERICOURT,     BLINKING_TERM, VITAMIN_C,                    LAVENDER_TEA,  BLINKING_TERM, SERICOURT,     SERICOURT,     SERICOURT,     BLINKING_TERM, XXXXXXXXXXXXX,
    ...
    [EXTRA_SYMB] = LED_LAYOUT_moonlander(
      ...
      XXXXXXXXXXXXX, HOT_BUTTER,    SOIL_AVAGDDU,  SOIL_AVAGDDU,  SOIL_AVAGDDU,  HOT_BUTTER,    VITAMIN_C,                    LAVENDER_TEA,  XXXXXXXXXXXXX, SOIL_AVAGDDU,  SOIL_AVAGDDU,  SOIL_AVAGDDU,  XXXXXXXXXXXXX, XXXXXXXXXXXXX,
    ...
    [MOVEMENT] = LED_LAYOUT_moonlander(
      ...
      XXXXXXXXXXXXX, XXXXXXXXXXXXX, SAPPHIRE_BLUE, SAPPHIRE_BLUE, SAPPHIRE_BLUE, XXXXXXXXXXXXX, VITAMIN_C,                    FOXY_FUCHSIA,  SKY_BLUE,      SAPPHIRE_BLUE, SAPPHIRE_BLUE, SAPPHIRE_BLUE, SKY_BLUE,      XXXXXXXXXXXXX,
    ...
    [SHORTCUTS] = LED_LAYOUT_moonlander(
      XXXXXXXXXXXXX, XXXXXXXXXXXXX, LAVENDER_TEA,  VITAMIN_C,       BABY_MOUTH,  SAPPHIRE_BLUE, XXXXXXXXXXXXX,                XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX, XXXXXXXXXXXXX,
