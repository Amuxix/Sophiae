...
uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [EXTRA_SYMB] = LED_LAYOUT_moonlander(
      HOT_BUTTER,    XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  VITAMIN_C,                    XXXXXXXXXXXXX, LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  LAVENDER_TEA,  XXXXXXXXXXXXX, LAVENDER_TEA,
