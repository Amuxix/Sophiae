...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [_BASE] = LED_LAYOUT_moonlander(
      H({202,122,255}), H({0,0,0}),       H({202,122,255}), H({202,122,255}), H({202,122,255}), H({202,122,255}), H({0,0,0}),                      H({0,0,0}),       H({202,122,255}), H({202,122,255}), H({202,122,255}), H({202,122,255}), H({0,0,0}),       H({202,122,255}),
      H({202,122,255}), H({202,122,255}), H({202,122,255}), H({202,122,255}), H({202,122,255}), H({202,122,255}), H({0,0,0}),                      H({0,0,0}),       H({202,122,255}), H({202,122,255}), H({202,122,255}), H({202,122,255}), H({202,122,255}), H({202,122,255}),
      H({0,0,0}),       H({202,122,255}), H({205,255,192}), H({205,255,192}), H({205,255,192}), H({202,122,255}), H({0,245,245}),                  H({243,255,185}), H({202,122,255}), H({205,255,192}), H({205,255,192}), H({205,255,192}), H({202,122,255}), H({0,0,0}),
      H({0,0,0}),       H({205,255,192}), H({202,122,255}), H({202,122,255}), H({202,122,255}), H({202,122,255}),                                              H({202,122,255}), H({202,122,255}), H({202,122,255}), H({202,122,255}), H({205,255,192}), H({0,0,0}),
      H({0,0,0}),       H({202,122,255}), H({202,122,255}), H({202,122,255}), H({0,245,245}),                  H({0,245,245}),                  H({0,245,245}),                  H({0,245,245}),   H({202,122,255}), H({202,122,255}), H({202,122,255}), H({0,0,0}),
                                                                  H({205,255,192}), H({202,122,255}), H({202,122,255}),                H({202,122,255}), H({202,122,255}), H({205,255,192})
    ),
