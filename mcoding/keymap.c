...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [_BASE] = LED_LAYOUT_moonlander(
      C({202,122,255}), C({0,0,0}),       C({202,122,255}), C({202,122,255}), C({202,122,255}), C({202,122,255}), C({0,0,0}),                      C({0,0,0}),       C({202,122,255}), C({202,122,255}), C({202,122,255}), C({202,122,255}), C({0,0,0}),       C({202,122,255}),
      C({202,122,255}), C({202,122,255}), C({202,122,255}), C({202,122,255}), C({202,122,255}), C({202,122,255}), C({0,0,0}),                      C({0,0,0}),       C({202,122,255}), C({202,122,255}), C({202,122,255}), C({202,122,255}), C({202,122,255}), C({202,122,255}),
      C({0,0,0}),       C({202,122,255}), C({205,255,192}), C({205,255,192}), C({205,255,192}), C({202,122,255}), C({0,245,245}),                  C({243,255,185}), C({202,122,255}), C({205,255,192}), C({205,255,192}), C({205,255,192}), C({202,122,255}), C({0,0,0}),
      C({0,0,0}),       C({205,255,192}), C({202,122,255}), C({202,122,255}), C({202,122,255}), C({202,122,255}),                                              C({202,122,255}), C({202,122,255}), C({202,122,255}), C({202,122,255}), C({205,255,192}), C({0,0,0}),
      C({0,0,0}),       C({202,122,255}), C({202,122,255}), C({202,122,255}), C({0,245,245}),                  C({0,245,245}),                  C({0,245,245}),                  C({0,245,245}),   C({202,122,255}), C({202,122,255}), C({202,122,255}), C({0,0,0}),
                                                                  C({205,255,192}), C({202,122,255}), C({202,122,255}),                C({202,122,255}), C({202,122,255}), C({205,255,192})
    ),
